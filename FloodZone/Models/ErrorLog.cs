...
namespace FloodZone.Models
{
  public class ErrorLog
  {
    public int AppId { get; set; } = 20034;
    public string ApplicationName { get; set; } = "Flood Zone";
    ...
    private void SaveLog()
    {
      string sql = @"
          ...
          VALUES (@applicationName, @errorText, @errorMessage,
            @errorStacktrace, @errorSource, @query);";
      string cs = ConfigurationManager.ConnectionStrings["LOG"].ConnectionString;
